...
public class Preferences {
	...
	public static OWLAnnotationProperty getTestCaseAnnotationProperty(OWLDataFactory dataFactory) {
		PreferencesManager preferenceManager = PreferencesManager.getInstance();
		org.protege.editor.core.prefs.Preferences preferences = preferenceManager.getApplicationPreferences(Preferences.class);
		String iriString = preferences.getString(
				TEST_CASE_IRI_STRING,
