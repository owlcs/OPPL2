...
public class PatternModelExpressionChecker implements
	...
	private ProtegePatternModel lastCreatedObject;

	public PatternModelExpressionChecker(OWLEditorKit owlEditorKit) {
	 ...
	 */
	public ProtegePatternModel createObject(String text)
