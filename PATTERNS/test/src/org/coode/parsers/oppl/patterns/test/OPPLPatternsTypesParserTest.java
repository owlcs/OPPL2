...
public class OPPLPatternsTypesParserTest extends TestCase {
	...
	public void testMenu() {
		...
		try {
			...
			final OWLReasoner reasoner = factory.createReasoner(referencedPatternOntology);
			this.patternModelFactory = new PatternModelFactory(referencedPatternOntology,
		...
		try {
			...
			if (tree != null) {
				...
				OPPLPatternsReferenceDefine patternReferenceDefine = new OPPLPatternsReferenceDefine(
						nodes, symtab, this.getListener(), getSimplePatternReferenceResolver(),
						constraintSystem);
