...
public abstract class AutoCompleter {
	...
	public AutoCompleter(JTextComponent tc) {
	...
	private List<String> getMatches() {
		...
		ManchesterOWLSyntaxTree tree = this.getTree();
		if (tree != null) {
			CommonTreeNodeStream nodes = this.getNodeStream();
			nodes.reset();
	...
	protected abstract ManchesterOWLSyntaxTree getTree();

	protected abstract SymbolTable getSymbolTable();

	protected abstract CommonTreeNodeStream getNodeStream();
