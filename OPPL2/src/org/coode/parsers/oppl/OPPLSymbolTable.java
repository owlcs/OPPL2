            ...
            toReturn = symbol
                    .accept(new OPPLSymbolVisitorEx<CollectionVariableAttributeSymbol<P, O>>() {
                        ...
                        public CollectionVariableAttributeSymbol<P, O> visitSymbol(
                                Symbol symbol) {
                            OPPLSymbolTable.this.reportIllegalToken(attributeSyntaxTree,
                        ...
                        public
                            ...
                            if (collectionVariableAttributeSymbol.getVariableAttribute()
                                ...
                                OPPLSymbolTable.this.reportIllegalToken(
                                        attributeSyntaxTree, "Wrong kind of symbol ");
                            }
                            return toReturn;
                        }
                    ...
                    .accept(new VariableTypeVisitorEx<OWLAxiom>() {
                        ...
                        public
                            ...
                            OPPLSymbolTable.this.reportIncompatibleSymbolType(expression,
                                    VariableType.ANNOTATIONPROPERTY, expression);
                            return null;
                        }
                        ...
                        public OWLAxiom visitCONSTANTVariableType(
                            ...
                            OPPLSymbolTable.this.reportIncompatibleSymbolType(expression,
                                    VariableType.CONSTANT, expression);
                            return null;
                        }
                        ...
                        public OWLAxiom visitINDIVIDUALVariableType(
                            ...
                            OPPLSymbolTable.this.reportIncompatibleSymbolType(expression,
                                    VariableType.INDIVIDUAL, expression);
                            return null;
                        }
