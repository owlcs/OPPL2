// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g 2011-02-03 09:15:20
...
public class OPPLScriptParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>",
			...
			"SAME_INDIVIDUAL", "DIFFERENT_INDIVIDUALS", "ESCLAMATION_MARK",
			"MATCH", "ATTRIBUTE_SELECTOR", "VALUES", "RENDERING", "GROUPS",
			"STRING_OPERATION", "VARIABLE_NAME", "REGEXP_CONSTRAINT", "FAIL",
			"NAF_CONSTRAINT", "LESS_THAN", "LESS_THAN_EQUAL", "GREATER_THAN",
			"GREATER_THAN_EQUAL", "DATA_RANGE", "570", "571", "572", "573",
	...
	// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:76:1: statement
	...
	public final OPPLScriptParser.statement_return statement()
		...
		try {
			// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:77:3: (
			// ( variableDefinitions )? ( query )? actions -> ^( OPPL_STATEMENT
			// ( variableDefinitions )? ( query )? actions ) )
			// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:5: (
			// variableDefinitions )? ( query )? actions
			{
				// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:5:
				// ( variableDefinitions )?
				...
				case 1:
					...
					// variableDefinitions
				{
					this.pushFollow(FOLLOW_variableDefinitions_in_statement100);
					...
					if (this.state.backtracking == 0) {
						stream_variableDefinitions.add(variableDefinitions1
								.getTree());
					}
				}
					break;
				}
				// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:26:
				// ( query )?
				int alt2 = 2;
				...
				case 1:
					...
					// query
				{
					this.pushFollow(FOLLOW_query_in_statement103);
					query2 = this.query();
					this.state._fsp--;
					if (this.state.failed) {
						return retval;
				...
				this.pushFollow(FOLLOW_actions_in_statement106);
				...
				if (this.state.backtracking == 0) {
					...
					// 78:41: -> ^( OPPL_STATEMENT ( variableDefinitions )? (
					// query )? actions )
					{
						// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:44:
						...
						// actions )
						{
							...
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
									(OPPLSyntaxTree) this.adaptor.create(
											OPPL_STATEMENT, "OPPL_STATEMENT"),
									root_1);
							// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:61:
							// ( variableDefinitions )?
							...
							// /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g:78:82:
							// ( query )?
							if (stream_query.hasNext()) {
								this.adaptor.addChild(root_1,
										stream_query.nextTree());
							}
							stream_query.reset();
							this.adaptor.addChild(root_1,
									stream_actions.nextTree());
	...
	public OPPLScript_OPPLParser.query_return query()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser_MOWLParser.axiom_return axiom()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser.regexp_return regexp()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser.actions_return actions()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser.action_return action()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser.atomic_return atomic()
			throws RecognitionException {
	...
	public OPPLScript_OPPLParser.nAryAxiom_return nAryAxiom()
			throws RecognitionException {
	...
	public static final BitSet FOLLOW_variableDefinitions_in_statement100 = new BitSet(
			new long[] { 0x0000000000000000L, 0x0000000000080800L });
	public static final BitSet FOLLOW_query_in_statement103 = new BitSet(
			new long[] { 0x0000000000000000L, 0x0000000000080800L });
	public static final BitSet FOLLOW_actions_in_statement106 = new BitSet(
