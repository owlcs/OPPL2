// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/luigi/Documents/workspace/PARSERS/src/OPPLScript.g 2010-11-12 16:58:48
...
public class OPPLScriptParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>",
			...
			"HAS_KEY", "ESCLAMATION_MARK", "MATCH", "ATTRIBUTE_SELECTOR",
			...
			"GREATER_THAN_EQUAL", "DATA_RANGE", "562", "563", "564", "565",
	...
	public final OPPLScriptParser.statement_return statement()
		...
		try {
			...
			// variableDefinitions )? query actions
			{
				...
				// AST REWRITE
				// elements: actions, variableDefinitions, query
				// token labels:
				// rule labels: retval
				// token list labels:
				// rule list labels:
