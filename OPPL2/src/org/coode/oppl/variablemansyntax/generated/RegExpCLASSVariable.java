...
public class RegExpCLASSVariable extends CLASSVariableImpl implements
		RegExpGenerated {
	private RegExpDelegate delegate;

	public RegExpCLASSVariable(String name, RegExpGeneratedValue exp) {
		super(name);
	...
	public Set<OWLObject> getPossibleBindings(BindingNode node) {
		return new HashSet<OWLObject>(this.delegate
				.getGeneratedOWLObjectCollection(node));
	}
