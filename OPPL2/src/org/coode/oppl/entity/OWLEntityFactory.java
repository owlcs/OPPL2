...
public interface OWLEntityFactory {
	public abstract OWLEntityCreationSet<OWLClass> createOWLClass(String shortName, IRI baseIRI)
	...
	public abstract OWLEntityCreationSet<OWLNamedIndividual> createOWLIndividual(String shortName,
			IRI baseIRI) throws OWLEntityCreationException;

	public abstract <T extends OWLEntity> OWLEntityCreationSet<T> createOWLEntity(Class<T> type,
			String shortName, IRI baseIRI) throws OWLEntityCreationException;

	public abstract void tryCreate(Class<? extends OWLEntity> type, String shortName, IRI baseIRI)
			throws OWLEntityCreationException;
