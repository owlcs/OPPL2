 ...
 * 
 */
abstract class AbstractVariableType<O extends OWLObject> implements
		VariableType<O> {
	private final VariableTypeName name;
	private final EnumSet<Direction> allowedDirections = EnumSet
	...
	public AbstractVariableType(VariableTypeName name,
		...
		if (allowedDirections == null) {
			throw new NullPointerException(
					"The allowed direction set cannot be null");
		}
		this.name = name;
