...
public class CorrectParseException extends Exception {
	 ...
	 * "tokenImage" set.
	 */
	public CorrectParseException(Token currentTokenVal,
	 ...
	 */
	public CorrectParseException() {
		super();
	}

	public CorrectParseException(Throwable t) {
		super(t);
	}

	public CorrectParseException(String message, Throwable t) {
		super(message, t);
	}

	/** Constructor with message. */
	public CorrectParseException(String message) {
		super(message);
	}
...
/*
 * JavaCC - OriginalChecksum=d681efe6f602b93134cf68f8fb5a3fe2 (do not edit this
 * line)
 */
