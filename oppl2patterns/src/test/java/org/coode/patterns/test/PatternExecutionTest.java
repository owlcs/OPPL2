    ...
    public void shouldTestPatternReference() {
        ...
        AddOntologyAnnotation addFoodPattern = new AddOntologyAnnotation(
            ...
            df.getOWLAnnotation(
                ...
                df.getOWLLiteral(
                    "?x:CLASS,?forbiddenContent:CLASS=createUnion(?x.VALUES) BEGIN ADD $thisClass equivalentTo hasTopping only (not ?forbiddenContent ) END;  A ?x free stuff ; RETURN $thisClass")));
