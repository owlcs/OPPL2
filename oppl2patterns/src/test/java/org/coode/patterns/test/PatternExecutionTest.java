...
public class PatternExecutionTest {
    ...
    public void testPatternReference() {
            ...
            instantiatedPatternModel.instantiate(patternModel.getConstraintSystem()
                    .getVariable("?content"), dataFactory.getOWLClass(IRI
                    .create("blah#A")));
            instantiatedPatternModel.instantiate(patternModel.getConstraintSystem()
                    .getVariable("?content"), dataFactory.getOWLClass(IRI
                    .create("blah#B")));
            ClassPatternExecutor executor = new ClassPatternExecutor(
                    patternCreatedOWLClass, instantiatedPatternModel, ontology, manager,
    ...
    public void testComplexExpressionConjuntionGeneratedVariablePattern() {
            ...
            instantiatedPatternModel.instantiate(anatomyPart, manager.getOWLDataFactory()
                    .getOWLClass(IRI.create("http://purl.org/obo/owl/MA#MA_0000368")));
            List<OWLAxiomChange> changes = executor.visit(instantiatedPatternModel
                    .getPatternModel());
    ...
    public void testNoVariables() {
            ...
            NonClassPatternExecutor patternExecutor = new NonClassPatternExecutor(ipm,
                    pizzaontology, man, IRI.create("http://example.owl#OPPL_pattern"),
                    handler);
