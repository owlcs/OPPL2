...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 MOWLLexer.g 2011-01-10 16:08:41
...
public class OPPLLintLexer_OPPLLexer_MOWLLexer extends Lexer {
	...
	// delegates
	// delegators
	public OPPLLintLexer gOPPLLintLexer;
	public OPPLLintLexer_OPPLLexer gOPPLLexer;
	public OPPLLintLexer_OPPLLexer gParent;

	public OPPLLintLexer_OPPLLexer_MOWLLexer() {
		;
	}

	public OPPLLintLexer_OPPLLexer_MOWLLexer(CharStream input, OPPLLintLexer gOPPLLintLexer,
			OPPLLintLexer_OPPLLexer gOPPLLexer) {
		this(input, new RecognizerSharedState(), gOPPLLintLexer, gOPPLLexer);
	}

	public OPPLLintLexer_OPPLLexer_MOWLLexer(CharStream input, RecognizerSharedState state,
			OPPLLintLexer gOPPLLintLexer, OPPLLintLexer_OPPLLexer gOPPLLexer) {
		super(input, state);
		this.gOPPLLintLexer = gOPPLLintLexer;
	...
	public final void mAND() throws RecognitionException {
		try {
			int _type = AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:38:5: ( 'and' )
			// MOWLLexer.g:38:7: 'and'
			{
				this.match("and");
			}
			this.state.type = _type;
	...
	public final void mNOT() throws RecognitionException {
		try {
			...
			switch (alt1) {
			case 1:
				// MOWLLexer.g:42:7: 'not'
			{
				this.match("not");
			}
				break;
			case 2:
				// MOWLLexer.g:42:15: 'NOT'
			{
				this.match("NOT");
			}
				break;
			case 3:
				// MOWLLexer.g:42:23: 'Not'
			{
				this.match("Not");
			}
				break;
	...
	public final void mSOME() throws RecognitionException {
		try {
			int _type = SOME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:44:7: ( 'some' )
			// MOWLLexer.g:44:9: 'some'
			{
				this.match("some");
			}
			this.state.type = _type;
	...
	public final void mONLY() throws RecognitionException {
		try {
			int _type = ONLY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:46:7: ( 'only' )
			// MOWLLexer.g:46:9: 'only'
			{
				this.match("only");
			}
			this.state.type = _type;
	...
	public final void mMIN() throws RecognitionException {
		try {
			int _type = MIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:48:7: ( 'min' )
			// MOWLLexer.g:48:9: 'min'
			{
				this.match("min");
			}
			this.state.type = _type;
	...
	public final void mMAX() throws RecognitionException {
		try {
			int _type = MAX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:50:7: ( 'max' )
			// MOWLLexer.g:50:9: 'max'
			{
				this.match("max");
			}
			this.state.type = _type;
	...
	public final void mEXACTLY() throws RecognitionException {
		try {
			int _type = EXACTLY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:52:11: ( 'exactly' )
			// MOWLLexer.g:52:13: 'exactly'
			{
				this.match("exactly");
			}
			this.state.type = _type;
	...
	public final void mVALUE() throws RecognitionException {
		try {
			int _type = VALUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:54:7: ( 'value' )
			// MOWLLexer.g:54:9: 'value'
			{
				this.match("value");
			}
			this.state.type = _type;
	...
	public final void mINVERSE() throws RecognitionException {
		try {
			int _type = INVERSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:56:9: ( ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'V' | 'v' ) )
			// MOWLLexer.g:56:11: ( 'I' | 'i' ) ( 'N' | 'n' ) ( 'V' | 'v' )
			{
	...
	public final void mSUBCLASS_OF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:59:13: ( ( 'S' | 's' ) 'ubClassOf' )
			// MOWLLexer.g:59:15: ( 'S' | 's' ) 'ubClassOf'
			{
	...
	public final void mSUB_PROPERTY_OF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:62:17: ( 'subPropertyOf' )
			// MOWLLexer.g:62:19: 'subPropertyOf'
			{
	...
	public final void mEQUIVALENT_TO() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:64:15: ( 'equivalentTo' )
			// MOWLLexer.g:64:17: 'equivalentTo'
			{
	...
	public final void mSAME_AS() throws RecognitionException {
		try {
			int _type = SAME_AS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:67:9: ( 'sameAs' | 'SameAs' )
			int alt2 = 2;
			...
			switch (alt2) {
			case 1:
				// MOWLLexer.g:67:10: 'sameAs'
			{
				this.match("sameAs");
			}
				break;
			case 2:
				// MOWLLexer.g:67:21: 'SameAs'
			{
				this.match("SameAs");
			}
				break;
	...
	public final void mDIFFERENT_FROM() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:70:17: ( 'differentFrom' | 'DifferentFrom' )
			int alt3 = 2;
			...
			switch (alt3) {
			case 1:
				// MOWLLexer.g:70:19: 'differentFrom'
			{
				this.match("differentFrom");
			}
				break;
			case 2:
				// MOWLLexer.g:70:37: 'DifferentFrom'
			{
				this.match("DifferentFrom");
			}
				break;
	...
	public final void mINVERSE_OF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:73:11: ( 'InverseOf' | 'inverseOf' )
			int alt4 = 2;
			...
			switch (alt4) {
			case 1:
				// MOWLLexer.g:73:15: 'InverseOf'
			{
				this.match("InverseOf");
			}
				break;
			case 2:
				// MOWLLexer.g:73:29: 'inverseOf'
			{
				this.match("inverseOf");
			}
				break;
	...
	public final void mDISJOINT_WITH() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:75:15: ( 'DisjointWith' | 'disjointWith' )
			int alt5 = 2;
			...
			switch (alt5) {
			case 1:
				// MOWLLexer.g:75:17: 'DisjointWith'
			{
				this.match("DisjointWith");
			}
				break;
			case 2:
				// MOWLLexer.g:75:34: 'disjointWith'
			{
				this.match("disjointWith");
			}
				break;
	...
	public final void mDOMAIN() throws RecognitionException {
		try {
			int _type = DOMAIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:78:9: ( 'Domain' | 'domain' )
			int alt6 = 2;
			...
			switch (alt6) {
			case 1:
				// MOWLLexer.g:79:5: 'Domain'
			{
				this.match("Domain");
			}
				break;
			case 2:
				// MOWLLexer.g:79:16: 'domain'
			{
				this.match("domain");
			}
				break;
	...
	public final void mRANGE() throws RecognitionException {
		try {
			...
			switch (alt7) {
			case 1:
				// MOWLLexer.g:82:5: 'Range'
			{
				this.match("Range");
			}
				break;
			case 2:
				// MOWLLexer.g:82:15: 'range'
			{
				this.match("range");
			}
				break;
	...
	public final void mHAS_KEY() throws RecognitionException {
		try {
			int _type = HAS_KEY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:86:2: ( ( 'H' | 'h' ) ( 'A' | 'a' ) ( 'S' | 's' ) (
			// 'K' | 'k' ) ( 'E' | 'e' ) ( 'Y' | 'y' ) )
			// MOWLLexer.g:87:3: ( 'H' | 'h' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'K'
			// | 'k' ) ( 'E' | 'e' ) ( 'Y' | 'y' )
			{
	...
	public final void mFUNCTIONAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:90:13: ( ( 'F' | 'f' ) 'unctional' ( ':' )? )
			// MOWLLexer.g:90:17: ( 'F' | 'f' ) 'unctional' ( ':' )?
			{
	...
	public final void mSYMMETRIC() throws RecognitionException {
		try {
			int _type = SYMMETRIC;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:92:12: ( ( 'S' | 's' ) 'ymmetric' ( ':' )? )
			// MOWLLexer.g:92:15: ( 'S' | 's' ) 'ymmetric' ( ':' )?
			{
				if (this.input.LA(1) == 'S' || this.input.LA(1) == 's') {
					this.input.consume();
				} else {
	...
	public final void mANTI_SYMMETRIC() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:95:17: ( ( 'A' | 'a' ) 'nti' ( 'S' | 's' ) 'ymmetric'
			// ( ':' )? )
			// MOWLLexer.g:95:19: ( 'A' | 'a' ) 'nti' ( 'S' | 's' ) 'ymmetric' (
			// ':' )?
			{
				if (this.input.LA(1) == 'A' || this.input.LA(1) == 'a') {
					this.input.consume();
	...
	public final void mREFLEXIVE() throws RecognitionException {
		try {
			int _type = REFLEXIVE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:98:12: ( ( 'R' | 'r' ) 'eflexive' ( ':' )? )
			// MOWLLexer.g:98:14: ( 'R' | 'r' ) 'eflexive' ( ':' )?
			{
	...
	public final void mIRREFLEXIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:100:14: ( ( 'I' | 'i' ) 'rreflexive' ( ':' )? )
			// MOWLLexer.g:100:16: ( 'I' | 'i' ) 'rreflexive' ( ':' )?
			{
				if (this.input.LA(1) == 'I' || this.input.LA(1) == 'i') {
					this.input.consume();
				} else {
	...
	public final void mTRANSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:102:14: ( ( 'T' | 't' ) 'ransitive' ( ':' )? )
			// MOWLLexer.g:102:16: ( 'T' | 't' ) 'ransitive' ( ':' )?
			{
	...
	public final void mINVERSE_FUNCTIONAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:105:19: ( ( 'I' | 'i' ) 'nverse' ( 'F' | 'f' )
			// 'unctional' ( ':' )? )
			// MOWLLexer.g:105:23: ( 'I' | 'i' ) 'nverse' ( 'F' | 'f' )
			// 'unctional' ( ':' )?
			{
				if (this.input.LA(1) == 'I' || this.input.LA(1) == 'i') {
					this.input.consume();
	...
	public final void mINSTANCE_OF() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:115:13: ( ( 'I' | 'i' ) 'nstance' ( 'O' | 'o' ) 'f' )
			// MOWLLexer.g:115:15: ( 'I' | 'i' ) 'nstance' ( 'O' | 'o' ) 'f'
			{
				if (this.input.LA(1) == 'I' || this.input.LA(1) == 'i') {
					this.input.consume();
				} else {
	...
	public final void mTYPES() throws RecognitionException {
		try {
			int _type = TYPES;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:118:7: ( ( 'T' | 't' ) 'ypes' )
			// MOWLLexer.g:118:9: ( 'T' | 't' ) 'ypes'
			{
				if (this.input.LA(1) == 'T' || this.input.LA(1) == 't') {
					this.input.consume();
				} else {
	...
	public final void mLESS_THAN_EQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:142:2: ( LESS_THAN EQUAL )
			// MOWLLexer.g:143:3: LESS_THAN EQUAL
			{
				this.mLESS_THAN();
				this.mEQUAL();
			}
	...
	public final void mGREATER_THAN_EQUAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:150:2: ( GREATER_THAN EQUAL )
			// MOWLLexer.g:151:3: GREATER_THAN EQUAL
			{
				this.mGREATER_THAN();
				this.mEQUAL();
			}
	...
	public final void mIRI() throws RecognitionException {
		try {
			int _type = IRI;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:175:2: ( LESS_THAN (~ GREATER_THAN )+ GREATER_THAN )
			// MOWLLexer.g:176:2: LESS_THAN (~ GREATER_THAN )+ GREATER_THAN
			{
				this.mLESS_THAN();
				// MOWLLexer.g:176:11: (~ GREATER_THAN )+
				int cnt16 = 0;
				loop16: do {
					int alt16 = 2;
					...
					{
						if (this.input.LA(1) >= '\u0000' && this.input.LA(1) <= '\u0202'
								|| this.input.LA(1) >= '\u0204' && this.input.LA(1) <= '\uFFFF') {
							this.input.consume();
						} else {
							MismatchedSetException mse = new MismatchedSetException(null,
									this.input);
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			int _type = INTEGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:192:8: ( ( DIGIT )+ )
			// MOWLLexer.g:192:10: ( DIGIT )+
			{
				// MOWLLexer.g:192:10: ( DIGIT )+
				int cnt17 = 0;
				loop17: do {
	...
	public final void mDIGIT() throws RecognitionException {
		try {
			// MOWLLexer.g:194:15: ( '0' .. '9' )
			// MOWLLexer.g:194:17: '0' .. '9'
			{
				this.matchRange('0', '9');
			}
		} finally {
	...
	public final void mIDENTIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MOWLLexer.g:196:12: ( LETTER ( LETTER | DIGIT | '-' | '_' | ':'
			// )* )
			// MOWLLexer.g:196:14: LETTER ( LETTER | DIGIT | '-' | '_' | ':' )*
			{
				this.mLETTER();
				// MOWLLexer.g:196:21: ( LETTER | DIGIT | '-' | '_' | ':' )*
				loop18: do {
					int alt18 = 2;
	...
	public void mTokens() throws RecognitionException {
			...
			// MOWLLexer.g:1:293: ANTI_SYMMETRIC
		{
			...
			break;
		case 31:
			// MOWLLexer.g:1:308: REFLEXIVE
		{
			this.mREFLEXIVE();
		}
			break;
		case 32:
			// MOWLLexer.g:1:318: IRREFLEXIVE
		{
			this.mIRREFLEXIVE();
		}
			break;
		case 33:
			// MOWLLexer.g:1:330: TRANSITIVE
		{
			this.mTRANSITIVE();
		}
			break;
		case 34:
			// MOWLLexer.g:1:341: INVERSE_FUNCTIONAL
		{
			this.mINVERSE_FUNCTIONAL();
		}
			break;
		case 35:
			// MOWLLexer.g:1:360: POW
		{
			this.mPOW();
		}
			break;
		case 36:
			// MOWLLexer.g:1:364: COMMA
		{
			this.mCOMMA();
		}
			break;
		case 37:
			// MOWLLexer.g:1:370: INSTANCE_OF
		{
			this.mINSTANCE_OF();
		}
			break;
		case 38:
			// MOWLLexer.g:1:382: TYPES
		{
			this.mTYPES();
		}
			break;
			...
			// MOWLLexer.g:1:430: EQUAL
		{
			...
			break;
		case 42:
			// MOWLLexer.g:1:436: LESS_THAN
		{
			this.mLESS_THAN();
		}
			break;
		case 43:
			// MOWLLexer.g:1:446: LESS_THAN_EQUAL
		{
			this.mLESS_THAN_EQUAL();
		}
			break;
		case 44:
			// MOWLLexer.g:1:462: GREATER_THAN
		{
			this.mGREATER_THAN();
		}
			break;
			...
			// MOWLLexer.g:1:475: GREATER_THAN_EQUAL
		{
			...
			break;
		case 46:
			// MOWLLexer.g:1:494: DBLQUOTE
		{
			this.mDBLQUOTE();
		}
			break;
		case 47:
			// MOWLLexer.g:1:503: IRI
		{
			this.mIRI();
		}
			break;
	...
	static final String DFA20_eotS = "\1\uffff\1\47\6\uffff\22\43\5\uffff\1\107\1\112\4\uffff\1\114\1"
			...
			+ "\1\u00df\6\43\1\uffff\4\43\1\uffff\6\43\1\uffff\20\43\1\u0102\1"
			+ "\43\1\u0104\7\43\1\u0104\1\u010d\3\43\1\u0111\1\43\1\u0102\1\uffff"
			+ "\1\43\1\uffff\1\43\1\u0115\5\43\1\u010d\1\uffff\1\u011b\1\u011e"
			+ "\1\43\1\uffff\3\43\1\uffff\1\u0124\4\43\1\uffff\1\u011b\1\u011e"
			+ "\1\uffff\2\43\1\u012b\1\43\1\u0124\1\uffff\1\43\1\u012e\1\43\1\u012e"
			+ "\1\u0131\1\u0132\1\uffff\1\43\1\u0134\1\uffff\1\u0134\1\u0131\2"
			+ "\uffff\1\43\1\uffff\2\43\2\u0139\1\uffff";
	...
	static final String DFA20_minS = "\1\11\1\55\6\uffff\1\156\1\157\1\117\2\141\1\161\1\141\1\116\1\141"
			...
			+ "\1\164\1\uffff\1\55\1\157\1\150\1\157\1\150\1\uffff\2\55\1\uffff"
			+ "\1\143\1\146\1\55\1\151\1\55\1\uffff\1\155\1\55\1\155\3\55\1\uffff"
	...
	static final String DFA20_maxS = "\1\175\1\172\6\uffff\1\156\2\157\1\171\1\151\1\170\1\141\1\162\1"
			...
			+ "\1\155\3\172\1\uffff\1\157\1\172\1\uffff\2\172\2\uffff\1\156\1\uffff"
			+ "\1\141\1\154\2\172\1\uffff";
	static final String DFA20_acceptS = "\2\uffff\1\2\1\3\1\4\1\5\1\6\1\7\22\uffff\1\43\1\44\1\47\1\50\1"
			...
			+ "\33\6\uffff\1\17\42\uffff\1\35\1\uffff\1\27\10\uffff\1\37\3\uffff"
			+ "\1\22\3\uffff\1\45\5\uffff\1\34\2\uffff\1\41\5\uffff\1\40\6\uffff"
			+ "\1\24\2\uffff\1\30\2\uffff\1\36\1\23\1\uffff\1\26\4\uffff\1\42";
