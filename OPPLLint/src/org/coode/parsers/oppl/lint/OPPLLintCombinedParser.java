// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g 2010-08-19 09:37:58
...
public class OPPLLintCombinedParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>",
			...
			"TEXT", "INFERENCE", "WS", "REGEXP_CONSTRAINT", "ATTRIBUTE_SELECTOR",
	...
	public String getGrammarFileName() {
		return "/Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g";
	}
	...
	// $ANTLR start "lint"
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:72:1:
	...
	public final OPPLLintCombinedParser.lint_return lint() throws RecognitionException {
		...
		RewriteRuleSubtreeStream stream_description = new RewriteRuleSubtreeStream(this.adaptor,
				"rule description");
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:73:3:
			// (name= text SEMICOLON ( INFERENCE )? statement returnClause
			// SEMICOLON exp= text SEMICOLON description -> ^( OPPL_LINT
			// IDENTIFIER[$name.text] ( INFERENCE )? statement returnClause ^(
			// EXPLANATION[$exp.text] $exp) description ) )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:74:5:
			// name= text SEMICOLON ( INFERENCE )? statement returnClause
			// SEMICOLON exp= text SEMICOLON description
			{
				...
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:74:27:
				// ( INFERENCE )?
				int alt1 = 2;
				...
				// AST REWRITE
				// elements: exp, statement, returnClause, INFERENCE,
				// description
				// token labels:
				...
				if (this.state.backtracking == 0) {
					...
					// EXPLANATION[$exp.text] $exp) description )
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:74:107:
						...
						// $exp) description )
						{
							...
							this.adaptor.addChild(root_1, this.adaptor.create(
									...
									(name != null ? this.input.toString(name.start, name.stop)
											: null)));
							// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:74:142:
							// ( INFERENCE )?
							...
							// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:74:176:
	...
	// $ANTLR start "text"
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:77:1:
	...
	public final OPPLLintCombinedParser.text_return text() throws RecognitionException {
		...
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:83:1:
			// ( (t= textBit )+ -> ^( TEXT[builder.toString()] ( textBit )+ ) )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:84:1:
			// (t= textBit )+
			{
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:84:1:
				// (t= textBit )+
				...
				loop2: do {
					...
					if (LA2_0 >= FUNCTIONAL && LA2_0 <= INVERSE_FUNCTIONAL || LA2_0 == IDENTIFIER
							|| LA2_0 == VARIABLE_NAME) {
						alt2 = 1;
					}
					switch (alt2) {
					case 1:
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:84:3:
						// t= textBit
					{
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:88:11:
	...
	// $ANTLR start "textBit"
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:91:1:
	...
	public final OPPLLintCombinedParser.textBit_return textBit() throws RecognitionException {
		...
		RewriteRuleTokenStream stream_FUNCTIONAL = new RewriteRuleTokenStream(this.adaptor,
				"token FUNCTIONAL");
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:92:2:
			...
			switch (alt3) {
			case 1:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:93:2:
				// IDENTIFIER
			{
				IDENTIFIER8 = (Token) this.match(
						this.input,
						IDENTIFIER,
						FOLLOW_IDENTIFIER_in_textBit221);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:93:16:
				...
				break;
			case 2:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:94:4:
				// VARIABLE_NAME
			{
				VARIABLE_NAME9 = (Token) this.match(
						this.input,
						VARIABLE_NAME,
						FOLLOW_VARIABLE_NAME_in_textBit234);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:94:22:
						// ^( TEXT VARIABLE_NAME )
						{
							OPPLSyntaxTree root_1 = (OPPLSyntaxTree) this.adaptor.nil();
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
				...
				break;
			case 3:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:95:4:
				// FUNCTIONAL
			{
				FUNCTIONAL10 = (Token) this.match(
						this.input,
						FUNCTIONAL,
						FOLLOW_FUNCTIONAL_in_textBit248);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:95:18:
				...
				break;
			case 4:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:96:8:
				// INVERSE_FUNCTIONAL
			{
				INVERSE_FUNCTIONAL11 = (Token) this.match(
						this.input,
						INVERSE_FUNCTIONAL,
						FOLLOW_INVERSE_FUNCTIONAL_in_textBit265);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:96:30:
				...
				break;
			case 5:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:97:7:
				// SYMMETRIC
			{
				SYMMETRIC12 = (Token) this.match(
						this.input,
						SYMMETRIC,
						FOLLOW_SYMMETRIC_in_textBit281);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:97:20:
						// ^( TEXT[$SYMMETRIC.text] )
						{
							OPPLSyntaxTree root_1 = (OPPLSyntaxTree) this.adaptor.nil();
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
				...
				break;
			case 6:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:98:7:
				// ANTI_SYMMETRIC
			{
				ANTI_SYMMETRIC13 = (Token) this.match(
						this.input,
						ANTI_SYMMETRIC,
						FOLLOW_ANTI_SYMMETRIC_in_textBit297);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:98:25:
				...
				break;
			case 7:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:99:7:
				// REFLEXIVE
			{
				REFLEXIVE14 = (Token) this.match(
						this.input,
						REFLEXIVE,
						FOLLOW_REFLEXIVE_in_textBit313);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:99:20:
						// ^( TEXT[$REFLEXIVE.text] )
						{
							OPPLSyntaxTree root_1 = (OPPLSyntaxTree) this.adaptor.nil();
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
				...
				break;
			case 8:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:100:7:
				// IRREFLEXIVE
			{
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:100:22:
				...
				break;
			case 9:
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:101:8:
				// TRANSITIVE
			{
				TRANSITIVE16 = (Token) this.match(
						this.input,
						TRANSITIVE,
						FOLLOW_TRANSITIVE_in_textBit346);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:101:22:
						// ^( TEXT[$TRANSITIVE.text] )
						{
							OPPLSyntaxTree root_1 = (OPPLSyntaxTree) this.adaptor.nil();
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
	...
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:104:1:
	...
	public final OPPLLintCombinedParser.statement_return statement() throws RecognitionException {
		...
		retval.start = this.input.LT(1);
		OPPLSyntaxTree root_0 = null;
		OPPLLintCombined_OPPLParser.variableDefinitions_return variableDefinitions17 = null;
		OPPLLintCombined_OPPLParser.query_return query18 = null;
		OPPLLintCombined_OPPLParser.actions_return actions19 = null;
		...
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:105:3:
			// ( ( variableDefinitions )? query ( actions )? -> ^(
			// OPPL_STATEMENT ( variableDefinitions )? query ( actions )? ) )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:5:
			// ( variableDefinitions )? query ( actions )?
			{
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:5:
				// ( variableDefinitions )?
				...
				case 1:
					...
					// variableDefinitions
				{
					this.pushFollow(FOLLOW_variableDefinitions_in_statement370);
					variableDefinitions17 = this.variableDefinitions();
					this.state._fsp--;
					if (this.state.failed) {
						return retval;
					}
					if (this.state.backtracking == 0) {
						stream_variableDefinitions.add(variableDefinitions17.getTree());
					}
				}
					break;
				}
				this.pushFollow(FOLLOW_query_in_statement373);
				query18 = this.query();
				this.state._fsp--;
				if (this.state.failed) {
					return retval;
				...
				if (this.state.backtracking == 0) {
					stream_query.add(query18.getTree());
				}
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:32:
				// ( actions )?
				int alt5 = 2;
				...
				case 1:
					...
					// actions
				{
					this.pushFollow(FOLLOW_actions_in_statement375);
					actions19 = this.actions();
					this.state._fsp--;
					if (this.state.failed) {
						return retval;
					}
					if (this.state.backtracking == 0) {
						stream_actions.add(actions19.getTree());
					}
				}
					break;
				}
				...
				if (this.state.backtracking == 0) {
					...
					// query ( actions )? )
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:44:
						...
						// actions )? )
						{
							...
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
									...
									root_1);
							// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:61:
							// ( variableDefinitions )?
							...
							// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:106:88:
							// ( actions )?
	...
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:111:1:
	...
	public final OPPLLintCombinedParser.returnClause_return returnClause()
		...
		OPPLSyntaxTree root_0 = null;
		Token RETURN20 = null;
		OPPLLintCombinedParser.returnValue_return returnValue21 = null;
		OPPLSyntaxTree RETURN20_tree = null;
		...
		RewriteRuleSubtreeStream stream_returnValue = new RewriteRuleSubtreeStream(this.adaptor,
				"rule returnValue");
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:112:3:
			// ( RETURN returnValue -> ^( RETURN returnValue ) )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:113:5:
			// RETURN returnValue
			{
				RETURN20 = (Token) this.match(this.input, RETURN, FOLLOW_RETURN_in_returnClause411);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
				...
				this.pushFollow(FOLLOW_returnValue_in_returnClause413);
				returnValue21 = this.returnValue();
				this.state._fsp--;
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
					stream_returnValue.add(returnValue21.getTree());
				}
				// AST REWRITE
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:113:27:
						// ^( RETURN returnValue )
						{
							OPPLSyntaxTree root_1 = (OPPLSyntaxTree) this.adaptor.nil();
							root_1 = (OPPLSyntaxTree) this.adaptor.becomeRoot(
	...
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:116:1:
	...
	public final OPPLLintCombinedParser.returnValue_return returnValue()
		...
		RewriteRuleTokenStream stream_VARIABLE_NAME = new RewriteRuleTokenStream(this.adaptor,
				"token VARIABLE_NAME");
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:117:3:
			// ( VARIABLE_NAME -> VARIABLE_NAME )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:118:7:
			// VARIABLE_NAME
			{
				VARIABLE_NAME22 = (Token) this.match(
						this.input,
						VARIABLE_NAME,
						FOLLOW_VARIABLE_NAME_in_returnValue442);
				if (this.state.failed) {
					return retval;
				}
				if (this.state.backtracking == 0) {
	...
	// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:121:1:
	...
	public final OPPLLintCombinedParser.description_return description()
		...
		StringBuilder builder = new StringBuilder();
		try {
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:126:3:
			// ( (a= . )+ -> ^( DESCRIPTION[builder.toString()] ( $a)+ ) )
			// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:127:5:
			// (a= . )+
			{
				// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:127:5:
				// (a= . )+
				...
				loop6: do {
					...
					switch (alt6) {
					case 1:
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:127:6:
						// a= .
					{
						a = this.input.LT(1);
				...
				if (this.state.backtracking == 0) {
					...
					{
						// /Users/luigi/Documents/workspace/ParsersOWL_API_2/src/OPPLLintCombined.g:132:11:
	...
	public static final BitSet FOLLOW_SEMICOLON_in_lint131 = new BitSet(new long[] {
			0x0000100FE0000000L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L,
	...
	public static final BitSet FOLLOW_textBit_in_text191 = new BitSet(new long[] {
			0x0000100FE0000002L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L,
			0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000010000L });
	public static final BitSet FOLLOW_IDENTIFIER_in_textBit221 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_VARIABLE_NAME_in_textBit234 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_FUNCTIONAL_in_textBit248 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_INVERSE_FUNCTIONAL_in_textBit265 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_SYMMETRIC_in_textBit281 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ANTI_SYMMETRIC_in_textBit297 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_REFLEXIVE_in_textBit313 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_IRREFLEXIVE_in_textBit329 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_TRANSITIVE_in_textBit346 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_variableDefinitions_in_statement370 = new BitSet(new long[] {
			0x0000000000000000L, 0x0000000000000800L, 0x0000000000000000L, 0x0000000000000000L,
			0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000810000L });
	public static final BitSet FOLLOW_query_in_statement373 = new BitSet(new long[] {
			0x0000000000000002L, 0x0000000000080000L });
	public static final BitSet FOLLOW_actions_in_statement375 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_RETURN_in_returnClause411 = new BitSet(new long[] {
			0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L,
			0x0000000000000000L, 0x0000000000000000L, 0x0000000000000000L, 0x0000000000010000L });
	public static final BitSet FOLLOW_returnValue_in_returnClause413 = new BitSet(
			new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_VARIABLE_NAME_in_returnValue442 = new BitSet(
			new long[] { 0x0000000000000002L });
}