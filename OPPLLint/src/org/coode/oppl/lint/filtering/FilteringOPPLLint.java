...
public class FilteringOPPLLint implements Lint<OWLObject> {
	...
	/**
	 * @param visitor
	 * @see org.coode.oppl.lint.OPPLLintScript#accept(org.semanticweb.owl.lint.LintVisitor)
	 */
	 ...
	 * @param visitor
	 * @return
	 * @see org.coode.oppl.lint.OPPLLintScript#accept(org.semanticweb.owl.lint.LintVisitorEx)
	 */
