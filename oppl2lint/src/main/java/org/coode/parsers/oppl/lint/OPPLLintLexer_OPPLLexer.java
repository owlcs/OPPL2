...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 OPPLLexer.g 2011-08-02 17:07:43
...
public class OPPLLintLexer_OPPLLexer extends Lexer {
	...
	public OPPLLintLexer gParent;

	public OPPLLintLexer_OPPLLexer() {
		;
	}

	public OPPLLintLexer_OPPLLexer(CharStream input, OPPLLintLexer gOPPLLintLexer) {
		this(input, new RecognizerSharedState(), gOPPLLintLexer);
	}

	public OPPLLintLexer_OPPLLexer(CharStream input, RecognizerSharedState state,
			OPPLLintLexer gOPPLLintLexer) {
		super(input, state);
		this.gMOWLLexer = new OPPLLintLexer_OPPLLexer_MOWLLexer(input, state, gOPPLLintLexer, this);
		this.gOPPLLintLexer = gOPPLLintLexer;
		this.gParent = gOPPLLintLexer;
	}
	...
	public final void mTO_LOWER_CASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// OPPLLexer.g:192:4: ( ( 'T' | 't' ) ( 'O' | 'o' ) ( 'L' | 'l' ) (
			// 'O' | 'o' ) ( 'W' | 'w' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'C' | 'c'
			// ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// OPPLLexer.g:193:5: ( 'T' | 't' ) ( 'O' | 'o' ) ( 'L' | 'l' ) (
			// 'O' | 'o' ) ( 'W' | 'w' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'C' | 'c'
			// ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
				if (this.input.LA(1) == 'T' || this.input.LA(1) == 't') {
	...
	public final void mTO_UPPER_CASE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// OPPLLexer.g:196:2: ( ( 'T' | 't' ) ( 'O' | 'o' ) ( 'U' | 'u' ) (
			// 'P' | 'p' ) ( 'P' | 'p' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'C' | 'c'
			// ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// OPPLLexer.g:197:2: ( 'T' | 't' ) ( 'O' | 'o' ) ( 'U' | 'u' ) (
			// 'P' | 'p' ) ( 'P' | 'p' ) ( 'E' | 'e' ) ( 'R' | 'r' ) ( 'C' | 'c'
			// ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
				if (this.input.LA(1) == 'T' || this.input.LA(1) == 't') {
	...
	public void mTokens() throws RecognitionException {
		...
		// ESCLAMATION_MARK | VARIABLE_NAME | TO_LOWER_CASE | TO_UPPER_CASE |
		// MOWLLexer. Tokens )
		int alt11 = 34;
			...
			// OPPLLexer.g:1:324: VARIABLE_NAME
		{
			...
			break;
		case 32:
			// OPPLLexer.g:1:338: TO_LOWER_CASE
		{
			this.mTO_LOWER_CASE();
		}
			break;
		case 33:
			// OPPLLexer.g:1:352: TO_UPPER_CASE
		{
			this.mTO_UPPER_CASE();
		}
			break;
		case 34:
			// OPPLLexer.g:1:366: MOWLLexer. Tokens
		{
	...
	static final String DFA11_eotS = "\1\uffff\7\31\1\50\1\31\3\uffff\12\31\1\uffff\1\31\1\uffff\11\31"
			...
			+ "\10\31\1\uffff\2\31\1\u0090\4\31\1\u012a\3\31\1\u012f\3\31\1\u012a"
			+ "\1\uffff\1\31\1\u0134\1\31\1\u012f\1\uffff\4\31\1\uffff\5\31\1\u013f"
			+ "\1\u0141\1\31\1\u0090\1\u013f\1\uffff\1\u0141\1\uffff\1\31\2\u0145" + "\1\uffff";
	...
	static final String DFA11_minS = "\1\11\1\114\1\102\1\101\1\104\1\116\1\105\1\110\1\75\1\101\3\uffff"
			...
			+ "\1\151\1\55\1\111\1\104\1\122\1\55\1\uffff\1\151\1\55\1\157\1\55"
			+ "\1\uffff\1\105\1\125\1\124\1\157\1\uffff\1\156\1\123\1\101\1\131"
			+ "\1\156\2\55\1\114\2\55\1\uffff\1\55\1\uffff\1\123\2\55\1\uffff";
	static final String DFA11_maxS = "\1\175\1\162\1\102\1\151\1\123\1\122\1\105\1\110\1\75\1\145\3\uffff"
			...
			+ "\105\1\172\1\164\1\146\1\151\1\172\1\151\1\144\1\122\1\172\1\uffff"
			+ "\1\151\1\172\1\157\1\172\1\uffff\1\145\1\165\1\124\1\157\1\uffff"
			+ "\1\156\1\163\1\141\1\131\1\156\2\172\1\154\2\172\1\uffff\1\172\1"
			+ "\uffff\1\163\2\172\1\uffff";
	static final String DFA11_acceptS = "\12\uffff\1\11\1\12\1\13\12\uffff\1\37\1\uffff\1\42\15\uffff\1\5"
			...
			+ "\1\25\20\uffff\1\23\4\uffff\1\21\4\uffff\1\26\12\uffff\1\15\1\uffff"
			+ "\1\22\3\uffff\1\24";
	...
	static final String[] DFA11_transitionS = {
			...
			"\1\u0128",
			"\1\31\2\uffff\12\31\1\u0129\6\uffff\32\31\4\uffff\1\31\1\uffff" + "\32\31",
			"\1\u012b", "\1\u012c", "\1\u012d",
			...
			"\1\31\2\uffff\12\31\1\u0140\6\uffff\32\31\4\uffff\1\31\1\uffff" + "\32\31",
			"\1\u0142\37\uffff\1\u0142",
			"\1\31\2\uffff\13\31\6\uffff\32\31\4\uffff\1\31\1\uffff\32\31",
			"\1\31\2\uffff\13\31\6\uffff\32\31\4\uffff\1\31\1\uffff\32\31", "",
			"\1\31\2\uffff\13\31\6\uffff\32\31\4\uffff\1\31\1\uffff\32\31", "",
			"\1\u0143\37\uffff\1\u0143",
			"\1\31\2\uffff\12\31\1\u0144\6\uffff\32\31\4\uffff\1\31\1\uffff" + "\32\31",
			"\1\31\2\uffff\13\31\6\uffff\32\31\4\uffff\1\31\1\uffff\32\31", "" };
