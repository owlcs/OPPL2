...
public class AssertContains implements Assertion {
	 ...
	 * @param value
	 */
	public AssertContains(Variable variable, OWLObject value, ConstraintSystem constraintSystem,
	...
	public String toString() {
		...
		formatter.format("%s CONTAINS %s", this.getVariable().getName(), renderer.toString());
