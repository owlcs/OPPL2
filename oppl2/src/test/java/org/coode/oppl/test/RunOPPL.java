...
public class RunOPPL {
	public void feedOPPL(String script, String ontologyName) throws OWLOntologyCreationException {
		OWLOntologyManager ontologyManager = OWLManager.createOWLOntologyManager();
		String opplScriptString = script;
		OWLOntology ontology = ontologyManager.loadOntologyFromOntologyDocument(this.getClass().getResourceAsStream(
				ontologyName));
