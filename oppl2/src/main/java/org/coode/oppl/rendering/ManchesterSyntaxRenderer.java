...
public class ManchesterSyntaxRenderer implements OWLObjectVisitor {
     ...
     * 
     * @param shortFormProvider The ShortFormProvide this rendere will use. Cannot be {@code null} .
    ...
    public ManchesterSyntaxRenderer(ShortFormProvider shortFormProvider) {
        delegate = new ManchesterOWLSyntaxObjectRenderer(out,
            checkNotNull(shortFormProvider, "shortFormProvider")) {
            @Override
            protected void writeSectionKeyword(ManchesterOWLSyntax keyword) {
                if (keyword == ManchesterOWLSyntax.SUB_PROPERTY_OF) {
                    write(" ", keyword, " ");
                } else {
                    super.writeSectionKeyword(keyword);
                }
            }
        };
    }
