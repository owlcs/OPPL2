 ...
 * OBJECTPROERTY or DATAPRPERTY {@link VariableType}, in particular this restricts the possible
 * values to the set of primitive object properties or data properties that are super-properties of
 * a given property
 * 
...
public class SuperPropertyVariableScope<P extends OWLPropertyExpression>
    ...
    boolean check(P property, Stream<OWLOntology> ontologies) {
        return EntitySearcher.getSubProperties(property, ontologies).anyMatch(property::equals);
    }
