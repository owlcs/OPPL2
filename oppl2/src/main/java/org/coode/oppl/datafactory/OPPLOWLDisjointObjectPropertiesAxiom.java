 ...
 */
public class OPPLOWLDisjointObjectPropertiesAxiom
    extends AbstractInlineSetAxiom<OWLObjectPropertyExpression>
    ...
    public OPPLOWLDisjointObjectPropertiesAxiom(OPPLOWLDataFactory dataFactory,
        ...
        delegate = dataFactory.getDelegate()
            .getOWLDisjointObjectPropertiesAxiom(propertyExpressions, annotations);
    }
