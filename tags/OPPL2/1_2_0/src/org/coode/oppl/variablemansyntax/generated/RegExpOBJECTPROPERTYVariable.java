...
public class RegExpOBJECTPROPERTYVariable extends OBJECTPROPERTYVariableImpl
		implements RegExpGenerated {
	private RegExpDelegate delegate;

	public RegExpOBJECTPROPERTYVariable(String name, RegExpGeneratedValue exp) {
		super(name);
