...
public class OPPLDefine extends TreeRewriter {
    ...
    public final OPPLDefine.groupAttributeReferences_return groupAttributeReferences() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                    ...
                    getSymbolTable().defineGroupAttributeReferenceSymbol(VARIABLE_NAME8,INTEGER12);
        ...
        try {
            ...
            switch (alt3) {
                case 1 :
                    ...
                    if ( state.backtracking==1 ) stream_VALUES.add(a);
                ...
                case 2 :
                    ...
                    if ( state.backtracking==1 ) stream_RENDERING.add(a);
            ...
            if ( state.backtracking==1 ) {
                    ...
                    getSymbolTable().defineAttributeReferenceSymbol(VARIABLE_NAME13,a);
    ...
    public static final BitSet FOLLOW_DOT_in_variableAttributeReferences213 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000C00000000L});
    public static final BitSet FOLLOW_VALUES_in_variableAttributeReferences221 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_RENDERING_in_variableAttributeReferences229 = new BitSet(new long[]{0x0000000000000008L});
