package org.coode.oppl.template.test;
...
public class TestStringTemplates extends TestCase {
	...
	public void testTemplateNoPlaceHolder() {
		...
		try {
			...
			System.out.println("TestStringTemplates.testTemplateNoPlaceHolder() " + opplScript);
	...
	public void testTemplateOnePlaceHolder() {
		...
		try {
			...
			OPPLScript opplScript = stringTemplate.replace();
			assertNotNull(opplScript);
			System.out.println("TestStringTemplates.testTemplateOnePlaceHolder() " + opplScript);
		} catch (OWLOntologyCreationException e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testTestPropertyBasedStringTemplateOnePlaceholder() {
		...
		try {
			...
			OPPLScript opplScript = stringTemplate.replace();
			assertNotNull(opplScript);
			System.out.println("TestStringTemplates.testTestPropertyBasedStringTemplateOnePlaceholder() "
					+ opplScript);
		} catch (OWLOntologyCreationException e) {
			e.printStackTrace();
			fail(e.getMessage());
	...
	public void testTestPropertyBasedStringTemplateOnePlaceholderButNoData() {
		...
		try {
			...
			System.out.println("TestStringTemplates.testTestPropertyBasedStringTemplateOnePlaceholderButNoData() Missing value (as expected)  "
					+ e.getMessage());
		}
	}
	...
	public void testTestPropertyBasedStringTemplateOnePlaceholderUsedTwice() {
		...
		try {
			...
			OPPLScript opplScript = stringTemplate.replace();
			assertNotNull(opplScript);
			System.out.println("TestStringTemplates.testTestPropertyBasedStringTemplateOnePlaceholderUsedTwice() "
					+ opplScript);
		} catch (OWLOntologyCreationException e) {
			e.printStackTrace();
			fail(e.getMessage());
	...
	public void testTestPropertyBasedStringTemplateOnePlaceholderUsingAnnotationForParsing() {
		OWLOntologyManager ontologyManager = OWLManager.createOWLOntologyManager();
		try {
			OWLOntology emptyOntology = ontologyManager.loadOntology(IRI.create("http://www.co-ode.org/ontologies/pizza/2007/02/12/pizza.owl"));
			OPPLParserCreationStrategy parserCreationStrategy = new AnnotationBasedSimpleOPPLParserCreationStrategy(
			...
			OPPLScript opplScript = stringTemplate.replace();
			assertNotNull(opplScript);
			System.out.println("TestStringTemplates.testTestPropertyBasedStringTemplateOnePlaceholderUsingAnnotationForParsing() "
					+ opplScript);
		} catch (OWLOntologyCreationException e) {
			e.printStackTrace();
			fail(e.getMessage());
