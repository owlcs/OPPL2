...
public class ProtegeParserFactory implements AbstractParserFactory {
    ...
    private class ProtegeOWLEntityChecker implements OWLEntityChecker {
        ...
        public OWLClass getOWLClass(String name) {
            ...
            if (owlEntity != null) {
                toReturn = owlEntity.accept(new OWLObjectVisitorExAdapter<OWLClass>(null) {
        ...
        public OWLAnnotationProperty getOWLAnnotationProperty(String name) {
            ...
            if (owlEntity != null) {
                toReturn = owlEntity
                    .accept(new OWLObjectVisitorExAdapter<OWLAnnotationProperty>(null) {
        ...
        public OWLDataProperty getOWLDataProperty(String name) {
            ...
            if (owlEntity != null) {
                toReturn = owlEntity
                    .accept(new OWLObjectVisitorExAdapter<OWLDataProperty>(null) {
        ...
        public OWLObjectProperty getOWLObjectProperty(String name) {
            ...
            if (owlEntity != null) {
                toReturn = owlEntity
                    .accept(new OWLObjectVisitorExAdapter<OWLObjectProperty>(null) {
        ...
        public OWLDatatype getOWLDatatype(String name) {
            ...
            OWLEntity owlEntity = getOWLEditorKit().getOWLModelManager()
                .getOWLEntityFinder().getOWLEntity(name);
            if (owlEntity != null) {
                toReturn = owlEntity.accept(new OWLObjectVisitorExAdapter<OWLDatatype>(null) {
        ...
        public OWLNamedIndividual getOWLIndividual(String name) {
            ...
            if (owlEntity != null) {
                toReturn = owlEntity
                    .accept(new OWLObjectVisitorExAdapter<OWLNamedIndividual>(null) {
